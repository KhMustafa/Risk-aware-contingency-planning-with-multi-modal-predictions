...
class VehicleParameters:
    ...
    def parameterize_ford_escort(self):
        ...
        self.longitudinal.v_max = 11  # maximum velocity [m/s]
    ...
    def parameterize_bmw_320i(self):
        ...
        # vehicle body dimensions
        self.l = 5  # vehicle length [m] (with US bumpers)
        self.l_f = (
            3.793293 / 2.595
        )  # length from the center of gravity to the front axle [m]
        self.l_r = (
        ...
        self.w = 2      # the one used in belief planning code
        ...
        self.longitudinal.v_max = 22  # maximum velocity [m/s]
        # self.longitudinal.v_max = 11

        self.longitudinal.v_switch = 7.319  # switching velocity [m/s]
        self.longitudinal.a_max = 4.0  # maximum absolute acceleration [m/s^2]
        #self.longitudinal.a_max = 5.5
        # lateral acceleration
        self.lateral_a_max = 20.0  # maximum lateral acceleartion [m/s^2]
