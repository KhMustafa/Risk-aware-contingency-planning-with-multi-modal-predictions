...
if __name__ == "__main__":
    ...
    from EthicalTrajectoryPlanning.planner.Frenet.configs.load_json import load_planning_json, load_weight_json, load_risk_json, load_contingency_json
...
if __name__ == "__main__":
    ...
    settings_dict["contingency_settings"] = load_contingency_json()
